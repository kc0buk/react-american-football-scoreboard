...
- [x] Submit a Pull-Request to merge `<firstName-lastName>` Branch into `main` (student's Repository). **Please don't merge your own pull request** (https://github.com/kc0buk/react-american-football-scoreboard/pull/1)
